 ...
 *
 * None of these commands carries or displays secret values: credentials are
 * reported as configured/not-configured only, and registrations set
 * `recordInput: false` so arguments are not duplicated into session logs.
 *
